...
eval(['export_fig Early_Ngenesis_V2_MKNN40_',date,'.pdf']);
...
%     'Stmn2','Tfap2c','Rhcg','Prox1'};
% 
% list_to_plot = {'Xist'    'Nnat'    'Id3'    '6330403K07Rik'    'Ncan'    'Fbxo2'};
% 
% xdata = get(Ptmp,'xdata');
% ydata = get(Ptmp,'ydata');
% 
...
eval(['export_fig Early_Ngenesis_age_V2_MKNN40_',date,'.pdf']);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
color_vec = distinguishable_colors(length(age_uni));
figure('position',[100,100,1400,600],'color','w');
[ha, pos] = tight_subplot(2, 4, [0.01,0.01], [0.01,0.05], [0.01,0.01]);
for i=1:length(age_uni)
%     subplot(2,4,i);
    axes(ha(i));
    Ptmp = plot(G,'xdata',xdata,'ydata',ydata);
...
eval(['export_fig Early_Ngenesis_age_subplots_V2_MKNN40_',date,'.pdf']);
...
eval(['export_fig Early_Ngenesis_markers1_V2_MKNN40_',date,'.pdf']);
...
eval(['export_fig Early_Ngenesis_markers2_V2_MKNN40_',date,'.pdf']);
