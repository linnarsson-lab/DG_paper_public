...
grlev2_uni = {'nipc_young','nipc','nb1','immature_granul','immature_pyr'};
...
i=1;
in1 = find(strcmpi(grlev2,'nb1') & age<=5);
in2 = find(strcmpi(grlev2,'nb1') & age>5);
...
title('NB E16-p5 vs >p18-132')
compname{i} = 'NB E16-p5 vs >p18-132';
i=2;
in1 = find(strcmpi(grlev2,'nb1') & (age<30 & age>5));
in2 = find(strcmpi(grlev2,'nb1') & age>30);
for j=1:length(ind_gr_tmp_mark)
    qval_table(j,i) =  ranksum(moldata(ind_gr_tmp_mark(j),in1), moldata(ind_gr_tmp_mark(j),in2)) ;
    fc_table(j,i) = mean(log2(moldata(ind_gr_tmp_mark(j),in1)+1)) - mean(log2(moldata(ind_gr_tmp_mark(j),in2)+1));
end
...
plot([0,1]*xl(2),[0,1]*xl(2),'k-');plot([0,1]*xl(2),1+[0,1]*xl(2),'k--');plot([0,1]*xl(2),-1+[0,1]*xl(2),'k--');
set(gca,'xlim',xl,'ylim',yl)
title('NB p18-23 vs >p120-132')
compname{i} = 'NB p18-23 vs >p120-132';
i=3;
in1 = find(strcmpi(grlev2,'nb1') );
...
plot([0,1]*xl(2),[0,1]*xl(2),'k-');plot([0,1]*xl(2),1+[0,1]*xl(2),'k--');plot([0,1]*xl(2),-1+[0,1]*xl(2),'k--');
set(gca,'xlim',xl,'ylim',yl)
title('NB vs nIPC young')
compname{i} = 'nb1 vs nipc-young';

i=5;
in1 = find(strcmpi(grlev2,'nb1') );
in2 = find(strcmpi(grlev2,'immature_pyr') );
for j=1:length(ind_gr_tmp_mark)
    qval_table(j,i) = ranksum(moldata(ind_gr_tmp_mark(j),in1), moldata(ind_gr_tmp_mark(j),in2)) ;
    fc_table(j,i) = mean(log2(moldata(ind_gr_tmp_mark(j),in1)+1)) - mean(log2(moldata(ind_gr_tmp_mark(j),in2)+1));
end
...
plot([0,1]*xl(2),[0,1]*xl(2),'k-');plot([0,1]*xl(2),1+[0,1]*xl(2),'k--');plot([0,1]*xl(2),-1+[0,1]*xl(2),'k--');
set(gca,'xlim',xl,'ylim',yl)
title('NB vs immature-pyr')
compname{i} = 'nb1 vs immature-pyr';
i=6;
in1 = find(strcmpi(grlev2,'nb1') );
...
plot([0,1]*xl(2),[0,1]*xl(2),'k-');plot([0,1]*xl(2),1+[0,1]*xl(2),'k--');plot([0,1]*xl(2),-1+[0,1]*xl(2),'k--');
set(gca,'xlim',xl,'ylim',yl)
title('NB vs immature-granul')
compname{i} = 'nb1 vs immature_granul';
i=7;
in1 = find(strcmpi(grlev2,'nb1') & age<=5);
in2 = find(strcmpi(grlev2,'nb1') & (age<30 & age>5));
for j=1:length(ind_gr_tmp_mark)
    qval_table(j,i) = ranksum(moldata(ind_gr_tmp_mark(j),in1), moldata(ind_gr_tmp_mark(j),in2)) ;
    fc_table(j,i) = mean(log2(moldata(ind_gr_tmp_mark(j),in1)+1)) - mean(log2(moldata(ind_gr_tmp_mark(j),in2)+1));
end
...
plot([0,1]*xl(2),[0,1]*xl(2),'k-');plot([0,1]*xl(2),1+[0,1]*xl(2),'k--');plot([0,1]*xl(2),-1+[0,1]*xl(2),'k--');
set(gca,'xlim',xl,'ylim',yl)
title('NB E16.5-p5 vs NB p18-23')
compname{i} = 'nb1 E16.5-p5 vs nb1 p18-23';
i=8;
in1 = find(strcmpi(grlev2,'nb1') & age<=5);
...
plot([0,1]*xl(2),[0,1]*xl(2),'k-');plot([0,1]*xl(2),1+[0,1]*xl(2),'k--');plot([0,1]*xl(2),-1+[0,1]*xl(2),'k--');
set(gca,'xlim',xl,'ylim',yl)
title('NB E16.5-p5 vs nIPC young')
compname{i} = 'nb1 E16.5-p5 vs nipc-young';
