...
grlev2_uni = {'immature_astro','astro_adol','astro_old','rgl','rgl_young','nipc_young','nipc','nb1'};
...
i=1;
in1 = find(strcmpi(grlev2,'nipc_young'));
...
title('nIPC perinatal vs RG')
compname{i} = 'nIPC perinatal vs RG';
i=2;
in1 = find(strcmpi(grlev2,'nipc') & age<=5);
in2 = find(strcmpi(grlev2,'nipc') & age>5);
for j=1:length(ind_gr_tmp_mark)
    qval_table(j,i) =  ranksum(moldata(ind_gr_tmp_mark(j),in1), moldata(ind_gr_tmp_mark(j),in2)) ;
    fc_table(j,i) = mean(log2(moldata(ind_gr_tmp_mark(j),in1)+1)) - mean(log2(moldata(ind_gr_tmp_mark(j),in2)+1));
end
...
plot([0,1]*xl(2),[0,1]*xl(2),'k-');plot([0,1]*xl(2),1+[0,1]*xl(2),'k--');plot([0,1]*xl(2),-1+[0,1]*xl(2),'k--');
set(gca,'xlim',xl,'ylim',yl)
title('nIPC E16-p5 vs >p18-132')
compname{i} = 'nIPC E16-p5 vs >p18-132';
i=3;
in1 = find(strcmpi(grlev2,'immature_astro') );
in2 = find(strcmpi(grlev2,'rgl_young') );
for j=1:length(ind_gr_tmp_mark)
    qval_table(j,i) =  ranksum(moldata(ind_gr_tmp_mark(j),in1), moldata(ind_gr_tmp_mark(j),in2)) ;
    fc_table(j,i) = mean(log2(moldata(ind_gr_tmp_mark(j),in1)+1)) - mean(log2(moldata(ind_gr_tmp_mark(j),in2)+1));
...
plot([0,1]*xl(2),[0,1]*xl(2),'k-');plot([0,1]*xl(2),1+[0,1]*xl(2),'k--');plot([0,1]*xl(2),-1+[0,1]*xl(2),'k--');
set(gca,'xlim',xl,'ylim',yl)
title('immature-Astro vs RG')
compname{i} = 'immature-Astro vs RG';
i=4;
in1 = find(strcmpi(grlev2,'immature_astro') );
in2 = find(strcmpi(grlev2,'nipc_young') );
for j=1:length(ind_gr_tmp_mark)
    qval_table(j,i) =  ranksum(moldata(ind_gr_tmp_mark(j),in1), moldata(ind_gr_tmp_mark(j),in2)) ;
    fc_table(j,i) = mean(log2(moldata(ind_gr_tmp_mark(j),in1)+1)) - mean(log2(moldata(ind_gr_tmp_mark(j),in2)+1));
end
...
plot([0,1]*xl(2),[0,1]*xl(2),'k-');plot([0,1]*xl(2),1+[0,1]*xl(2),'k--');plot([0,1]*xl(2),-1+[0,1]*xl(2),'k--');
set(gca,'xlim',xl,'ylim',yl)
title('immature-Astro vs nIPC perinatal')
compname{i} = 'immature-Astro vs nIPC perinatal';

i=5;
in1 = find(strcmpi(grlev2,'nipc') );
in2 = find(strcmpi(grlev2,'rgl') );
for j=1:length(ind_gr_tmp_mark)
    qval_table(j,i) = ranksum(moldata(ind_gr_tmp_mark(j),in1), moldata(ind_gr_tmp_mark(j),in2)) ;
    fc_table(j,i) = mean(log2(moldata(ind_gr_tmp_mark(j),in1)+1)) - mean(log2(moldata(ind_gr_tmp_mark(j),in2)+1));
end
...
set(gca,'xlim',xl,'ylim',yl)
title('nIPC vs RGL')
compname{i} = 'nIPC vs RGL';
i=6;
in1 = find(strcmpi(grlev2,'nipc') & age<=5);
in2 = find(strcmpi(grlev2,'nipc') & age>5 & age<=23);
for j=1:length(ind_gr_tmp_mark)
    qval_table(j,i) =  ranksum(moldata(ind_gr_tmp_mark(j),in1), moldata(ind_gr_tmp_mark(j),in2)) ;
    fc_table(j,i) = mean(log2(moldata(ind_gr_tmp_mark(j),in1)+1)) - mean(log2(moldata(ind_gr_tmp_mark(j),in2)+1));
end
...
plot([0,1]*xl(2),[0,1]*xl(2),'k-');plot([0,1]*xl(2),1+[0,1]*xl(2),'k--');plot([0,1]*xl(2),-1+[0,1]*xl(2),'k--');
set(gca,'xlim',xl,'ylim',yl)
title('nIPC (E16.5-p5) vs nIPC p18-23)')
compname{i} = 'nIPC (E16.5-p5) vs nIPC p18-23)';
i=7;
in1 = find(strcmpi(grlev2,'astro_adol') );
in2 = find(strcmpi(grlev2,'rgl') );
for j=1:length(ind_gr_tmp_mark)
    qval_table(j,i) = ranksum(moldata(ind_gr_tmp_mark(j),in1), moldata(ind_gr_tmp_mark(j),in2)) ;
    fc_table(j,i) = mean(log2(moldata(ind_gr_tmp_mark(j),in1)+1)) - mean(log2(moldata(ind_gr_tmp_mark(j),in2)+1));
...
plot([0,1]*xl(2),[0,1]*xl(2),'k-');plot([0,1]*xl(2),1+[0,1]*xl(2),'k--');plot([0,1]*xl(2),-1+[0,1]*xl(2),'k--');
set(gca,'xlim',xl,'ylim',yl)
title('Asto-adol vs RGL')
compname{i} = 'Asto-adol vs RGL';
i=8;
in1 = find(strcmpi(grlev2,'astro_adol') );
in2 = find(strcmpi(grlev2,'nipc') );
for j=1:length(ind_gr_tmp_mark)
    qval_table(j,i) =  ranksum(moldata(ind_gr_tmp_mark(j),in1), moldata(ind_gr_tmp_mark(j),in2)) ;
    fc_table(j,i) = mean(log2(moldata(ind_gr_tmp_mark(j),in1)+1)) - mean(log2(moldata(ind_gr_tmp_mark(j),in2)+1));
end
...
plot([0,1]*xl(2),[0,1]*xl(2),'k-');plot([0,1]*xl(2),1+[0,1]*xl(2),'k--');plot([0,1]*xl(2),-1+[0,1]*xl(2),'k--');
set(gca,'xlim',xl,'ylim',yl)
title('Asto-adol vs nIPC')
compname{i} = 'Asto-adol vs nIPC';

eval(['export_fig group_comp4_scatter_ranksum_othergroups_',date,'.pdf']);
...
saveCellFile(table1,['group_comp4_ranksum_othergroups_',date,'.txt']);
